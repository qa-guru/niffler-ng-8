...
public class GenCategoryExtension implements ParameterResolver, AfterEachCallback {

    public static final SpendServiceClient SPEND_CLIENT = SpendService.client();
    private static final Faker FAKER = Faker.instance();
    public static final ExtensionContext.Namespace NAMESPACE = ExtensionContext.Namespace.create(GenCategoryExtension.class);

    @Override
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        return AnnotationSupport.isAnnotated(extensionContext.getRequiredTestMethod(), GenCategory.class)
    ...
    public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
        ...
        GenCategory categoryAnno = AnnotationSupport.findAnnotation(extensionContext.getRequiredTestMethod(), GenCategory.class).get();
