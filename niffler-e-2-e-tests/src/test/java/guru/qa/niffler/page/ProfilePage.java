...
public class ProfilePage {
    ...
    private final SelenideElement showArchivedToggle = $("input[type='checkbox']").as("Archived toggle");
    ...
    public ProfilePage checkCategoryNotExists(String category) {
        bubbles.find(text(category)).shouldNotBe(visible);
        return this;
    }
    ...
    public ProfilePage disableArchivedToggle() {
        if (showArchivedToggle.isSelected()) {
            showArchivedToggle.parent().click();
        }
        return this;
    }
}
